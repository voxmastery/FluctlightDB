...
\begin{itemize}
  ...
  parity with a tuned vector baseline on BEIR SciFact, and 97--98\% macro on an agent-specific
  benchmark.
...
\texttt{benchmarks/results/paper-2026-07-07.json} (LoCoMo, BEIR, FAMB from
2025-06-22; LongMemEval unified v4 retrieval from 2026-07-04; E2E QA from
2026-07-07).
...
matter, recalls 98.1\% of gold evidence on LoCoMo, 97.6\% session recall on
