...
\author{Ganesh S\\ \small Independent Researcher \quad \texttt{voxmastery@ambugo.tech}\\[0.2em]
...
define a standalone embedded memory \emph{engine contract}. \textbf{HippoRAG}~\cite{gutiérrez2024hipporag}
...
\url{https://search.ambugo.help/paper/}.
