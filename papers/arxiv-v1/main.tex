...
forgetting). Integrating them into the live recall hot path and measuring the effect on
end-to-end LongMemEval accuracy is ongoing work; the mechanisms ship enabled-by-flag so the
retrieval numbers in Section~\ref{sec:eval} are unaffected.
