...
\textbf{100\%} index and \textbf{98\%} agent macro on a July 2026 rerun. The engine, harnesses, and frozen metrics
...
vs.\ 0.927; agent row from certified June 2025 run---rerun via
\texttt{beir\_bench.py --skip-index --agent-mode agent}, $\sim$3h wall time on
full SciFact).
