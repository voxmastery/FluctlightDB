...
- **Benchmarks are frozen claims:** README numbers (**99.0%** LoCoMo, 97.6% LongMemEval-S) map to `benchmarks/results/paper-2026-07-09.json`. Changing recall code requires re-running before touching README.
