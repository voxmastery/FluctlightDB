...
pip install "fluctlightdb[native]>=0.5.9"   # Linux / macOS / Windows (x64 + arm64); abi3 wheel for Python 3.9–3.13
```
...
make reproduce-locomo          # downloads data, runs CHORUS eval, checks frozen cert
